            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        <h3 class="fs-1 fw-semibold mb-3 text-center">Create New Password</h3>
                        <p class="fw-normal text-muted mb-3 text-center">Your new password must be different <br> from previously used password.</p>
                        <form action="" method="POST">
                            ...
                            <a type="submit" href="" class="btn btn-primary fw-bold fs-17 w-100 radius-15 mt-2">Reset Password</a>
                        </form>
