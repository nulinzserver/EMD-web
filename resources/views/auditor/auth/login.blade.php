            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        <h2 class="fs-1 fw-semibold mb-3 text-center">Auditor Portal</h2>
                        ...
                        <form class="" action="" method="POST">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <a href="{{ route('forgot_pass_auditor') }}" class="text-decoration-none">Forgot Password?</a>

                            </div>
                            <button type="submit" class="btn btn-primary fw-bold fs-17 w-100 radius-15">Sign In</button>
                        </form>
                        <p class="fs-14 mt-3 text-center">
                            Already have an account? <a href="{{ route('signup_auditor') }}" class="fs-17 text-blue ms-1"> Sign-up</a>
                        </p>
                    </div>
                </div>
            </div>
