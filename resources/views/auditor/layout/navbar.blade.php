                    ...
                    <div class="sidebar-user mb-2 px-2 py-0">
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="position-relative flex-shrink-0">
                                <img src="{{ asset('assets/images/avatar.jpg') }}" class="img-fluid me-1 rounded" width="80px" height="80px" id="profileImage">
                            </div>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="" id="" class="form-control" minlength="6" data-toggle="tooltip" data-placement="top"
