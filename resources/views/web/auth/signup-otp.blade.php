            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        ...
                        <form action="{{ route('verify_otp') }}" method="post" id="otpForm">
                            @csrf
                            ...
                            <button class="btn btn-primary fw-bold fs-4 w-100 radius-15 mt-2">Verify</button>
                        </form>

                        <form class="mt-3">
                            <input type="hidden" id="phone_number" name="phone_number" value="{{ $phone_number }}">
                            <p class="fs-15 text-center mb-0">OTP: {{ $otp }}</p>
