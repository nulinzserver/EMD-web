            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form-section">
                        ...
                        <form action="{{ route('update_no_insights') }}" method="POST">
                            @csrf
                            ...
                            <form action="{{ route('skip', ['id' => $phone]) }}" method="POST" class="mt-3">
                                @csrf
                                <button type="submit" class="btn btn-link fw-bold fs-15 w-100 p-0 text-center">
                                    Skip
                                </button>
                            </form>
                        </form>
