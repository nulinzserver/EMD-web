                ...
                <div class="col-md-6">
                    ...
                    <div class="form-section">
                        ...
                        <form action="{{ route('set_password_nogst') }}" method="POST">
                            ...
                            <button class="btn btn-primary fw-bold fs-17 w-100 radius-15 mt-2">Create Password</button>
                        </form>
